  ...
  return (
    <SafeAreaView style={estilos.conteiner}>
      ...
      <View style={estilos.conteudo}>
        ...
        <Text style={estilos.nome}>Lamen</Text>
        <Text style={estilos.preco}>R$ 38,90</Text>
        <Text style={estilos.descricao}>Massa macia de macarrão em caldo saboroso e quente, acompanhado de fatias de carne, ovo cozido e cebolinha.</Text>
      </View>
    </SafeAreaView>
  )
}
