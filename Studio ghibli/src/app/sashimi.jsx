  ...
  return (
    <SafeAreaView style={estilos.conteiner}>
      ...
      <View style={estilos.conteudo}>
        ...
        <Text style={estilos.categoria}>Salgados</Text>
        <Text style={estilos.nome}>Prato de Sashimi e Frutos do Mar</Text>
        <Text style={estilos.preco}>R$ 67,00</Text>
        <Text style={estilos.descricao}>Seleção de peixes frescos e frutos do mar com fatias de limão e acompanhamentos tradicionais.</Text>
      </View>
    </SafeAreaView>
  )
}
