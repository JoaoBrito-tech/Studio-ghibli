  ...
  return (
    <SafeAreaView style={estilos.conteiner}>
      ...
      <View style={estilos.conteudo}>
        ...
        <Text style={estilos.nome}>Matcha na Xícara</Text>
        <Text style={estilos.preco}>R$ 14,90</Text>
        <Text style={estilos.descricao}>Chá verde artesanal morno, servido em louça delicada para proporcionar um momento de relaxamento e conforto.</Text>
      </View>
    </SafeAreaView>
  )
}
