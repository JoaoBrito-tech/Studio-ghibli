  ...
  return (
    <SafeAreaView style={estilos.conteiner}>
      ...
      <View style={estilos.conteudo}>
        ...
        <Text style={estilos.nome}>Bento (Marmita Japonesa)</Text>
        <Text style={estilos.preco}>R$ 42,90</Text>
        <Text style={estilos.descricao}>Marmita tradicional com arroz, peixe grelhado, conservas e acompanhamentos equilibrados.</Text>
      </View>
    </SafeAreaView>
  )
}
