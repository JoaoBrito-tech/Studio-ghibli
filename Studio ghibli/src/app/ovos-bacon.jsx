  ...
  return (
    <SafeAreaView style={estilos.conteiner}>
      ...
      <View style={estilos.conteudo}>
        ...
        <Text style={estilos.nome}>Ovos com Bacon na Frigideira</Text>
        <Text style={estilos.preco}>R$ 24,50</Text>
        <Text style={estilos.descricao}>Ovos fritos na hora acompanhados de fatias crocantes de bacon dourado na frigideira.</Text>
      </View>
    </SafeAreaView>
  )
}
