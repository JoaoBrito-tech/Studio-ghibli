  ...
  return (
    <SafeAreaView style={estilos.conteiner}>
      ...
      <View style={estilos.conteudo}>
        ...
        <Text style={estilos.nome}>Bolo de Chocolate da Kiki</Text>
        <Text style={estilos.preco}>R$ 22,00</Text>
        <Text style={estilos.descricao}>Bolo de chocolate fofinho coberto com uma camada lisa de ganache e decorado com o desenho da bruxinha Kiki.</Text>
      </View>
    </SafeAreaView>
  )
}
