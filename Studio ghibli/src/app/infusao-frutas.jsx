  ...
  return (
    <SafeAreaView style={estilos.conteiner}>
      ...
      <View style={estilos.conteudo}>
        ...
        <Text style={estilos.nome}>Infusão de Frutas</Text>
        <Text style={estilos.preco}>R$ 16,50</Text>
        <Text style={estilos.descricao}>Chá leve e aromático servido com fatias frescas de limão e acompanhado de biscoitos finos.</Text>
      </View>
    </SafeAreaView>
  )
}
