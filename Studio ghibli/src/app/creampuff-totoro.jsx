  ...
  return (
    <SafeAreaView style={estilos.conteiner}>
      ...
      <View style={estilos.conteudo}>
        ...
        <Text style={estilos.nome}>Cream Puff de Totoro (Choux Cream)</Text>
        <Text style={estilos.preco}>R$ 18,90</Text>
        <Text style={estilos.descricao}>Sobremesa delicada em formato de Totoro, recheada com um creme leve, aveludado e finalizada com detalhes artesanais.</Text>
      </View>
    </SafeAreaView>
  )
}
