  ...
  return (
    <SafeAreaView style={estilos.conteiner}>
      ...
      <View style={estilos.conteudo}>
        ...
        <Text style={estilos.nome}>Garrafas de Bebidas Tradicionais / Saquê</Text>
        <Text style={estilos.preco}>R$ 28,00</Text>
        <Text style={estilos.descricao}>Seleção de bebidas tradicionais engarrafadas, perfeitas para acompanhar pratos especiais.</Text>
      </View>
    </SafeAreaView>
  )
}
