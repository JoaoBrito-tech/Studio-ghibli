  ...
  return (
    <SafeAreaView style={estilos.conteiner}>
      ...
      <View style={estilos.conteudo}>
        ...
        <Text style={estilos.categoria}>Doces</Text>
        <Text style={estilos.nome}>Siberia (Bolo recheado com Yokan)</Text>
        <Text style={estilos.preco}>R$ 15,50</Text>
        <Text style={estilos.descricao}>Doce tradicional japonês composto por fatias de pão de ló macio recheadas com uma camada firme de pasta de feijão azuki (yokan).</Text>
      </View>
    </SafeAreaView>
  )
}
